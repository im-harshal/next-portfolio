...
export const infoList = [
  {
    ...
    title: "Languages",
    description: "JavaScript, Python, Java SQL, HTML, CSS, C++",
  },
  {
    icon: assets.edu_icon,
    iconDark: assets.edu_icon_dark,
    title: "Education",
    description: "MS in Computer Science BTech in CSE",
  },
  {
    icon: assets.project_icon,
    iconDark: assets.project_icon_dark,
    title: "Projects",
    description: "Built projects in Next Js, React Js and Spring",
  },
];
